...
def getSelectionAverage(Path):
    ...
    xcoor = int(point[0])
    ycoor = int(point[1])
    color1 = image[ycoor][xcoor]
    point = refPt[1]
    xcoor = int(point[0])
    ycoor = int(point[1])
    color2 = image[ycoor][xcoor]
    point = refPt[2]
    xcoor = int(point[0])
    ycoor = int(point[1])
    color3 = image[ycoor][xcoor]
    red = color1[0]+color2[0]+color3[0]/255
    green = color1[1]+color2[1]+color3[1]/255
    blue = color1[2]+color2[2]+color3[2]/255
    color1[0]=red
    color1[1]=green
    color1[2]=blue
    return color1
